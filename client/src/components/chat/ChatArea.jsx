...
export default function ChatArea({ messages, isLoading, hasSources }) {
    ...
    <ScrollArea className="flex-1">
      <div className="mx-auto flex max-w-3xl flex-col px-4 py-6">
        ...
        {messages.length === 0 && !isLoading && (
          <div className="flex flex-1 flex-col items-center justify-center gap-4 py-24 opacity-60">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-border bg-card">
              <MessageSquare size={24} className="text-primary" />
            </div>
            <div className="text-center">
              <p className="mb-1.5 text-base font-semibold text-foreground">DocMind</p>
              <p className="max-w-xs text-sm text-muted-foreground leading-relaxed">
                {hasSources
                  ? 'Ask any question about your uploaded documents or URLs.'
